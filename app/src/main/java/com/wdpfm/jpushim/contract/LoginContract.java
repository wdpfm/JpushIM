package com.wdpfm.jpushim.contract;
/*
...
import com.wdpfm.jpushim.presenter.BasePresenter;
 ...
 * 项目名称：XiaYiYeChat
 * 文件包名：com.wdpfm.jpushim.contract
 * 文件说明：
 */
public interface LoginContract {
    ...
    interface Presenter extends BasePresenter {
        boolean inject(String account, String pwd);
